...
honor likes falls to compelled violations. As discussed in
...
%% Dropbox publishes a transparency report~\cite{dropbox-transparency}
%% indicating how frequently they are compelled to violate user
%% privacy. Recent versions of this report indicate that Dropbox
%% receives a few hundred requests for various user data every six
%% months.
...
%%   that would make such assistance difficult or impossible to
%%   provide.
%%  \item[Bankruptcy]
%% \end{packed_desc}
